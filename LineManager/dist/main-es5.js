...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, exports, __webpack_require__) {
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(i0.ɵɵdirectiveInject(i1.SocketioService));
    };
    ...
    AppComponent.ɵcmp = i0.ɵɵdefineComponent({
      ...
      directives: [i2.SocketComponent, i3.RouterOutlet],
  ...
  function srcAppAppModuleTs(module, exports, __webpack_require__) {
    ...
    var socket_component_1 = __webpack_require__(
    /*! ./components/sockets/socket.component */
    "./src/app/components/sockets/socket.component.ts");
    ...
    var socket_service_1 = __webpack_require__(
    /*! ./services/websocket/socket.service */
    "./src/app/services/websocket/socket.service.ts");
    ...
    AppModule.ɵmod = i0.ɵɵdefineNgModule({
      type: AppModule,
      bootstrap: [app_component_1.AppComponent, socket_component_1.SocketComponent]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(AppModule, {
        declarations: [app_component_1.AppComponent, socket_component_1.SocketComponent],
        imports: [platform_browser_1.BrowserModule, app_routing_module_1.AppRoutingModule, forms_1.FormsModule]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppComponentsSocketsSocketComponentTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var i1 = __webpack_require__(
    /*! src/app/services/websocket/socket.service */
    "./src/app/services/websocket/socket.service.ts");
    ...
    function SocketComponent_div_9_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var Message = function Message(sender, content) {
      var isBroadcast = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    /*#__PURE__*/
    function () {
      function SocketComponent(socketService) {
        ...
        this.getMessages = function () {// return Observable.create((observer) => {
    ...
    SocketComponent.ɵfac = function SocketComponent_Factory(t) {
      return new (t || SocketComponent)(i0.ɵɵdirectiveInject(i1.SocketioService));
    };

    SocketComponent.ɵcmp = i0.ɵɵdefineComponent({
      type: SocketComponent,
      selectors: [["socket"]],
      viewQuery: function SocketComponent_Query(rf, ctx) {
        if (rf & 1) {
      ...
      decls: 10,
      vars: 2,
      consts: [[1, "container"], [1, "header"], [1, "footer"], [3, "submit"], ["name", "clientMessage", "placeholder", "Write a message", "type", "text", 3, "ngModel", "ngModelChange"], ["mat-fab", "", "type", "submit"], [1, "material-icons"], [4, "ngFor", "ngForOf"], [1, "content"]],
      template: function SocketComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          i0.ɵɵlistener("submit", function SocketComponent_Template_form_submit_3_listener($event) {
            return ctx.send();
          });
          i0.ɵɵelementStart(4, "input", 4);
          i0.ɵɵlistener("ngModelChange", function SocketComponent_Template_input_ngModelChange_4_listener($event) {
            return ctx.clientMessage = $event;
          });
          i0.ɵɵelementEnd();
      ...
      directives: [i2.ɵangular_packages_forms_forms_y, i2.NgControlStatusGroup, i2.NgForm, i2.DefaultValueAccessor, i2.NgControlStatus, i2.NgModel, i3.NgForOf],
    ...
    (function () {
      i0.ɵsetClassMetadata(SocketComponent, [{
        type: core_1.Component,
        args: [{
          selector: 'socket',
  ...
  /***/
  function srcAppServicesWebsocketSocketServiceTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(SocketioService, [{
        ...
        value: function setupSocketConnection() {
          ...
          this.socket.on('onListen', function (data) {
            console.log(data);
          });
        }
      }, {
    ...
    SocketioService.ɵprov = i0.ɵɵdefineInjectable({
    ...
    (function () {
      i0.ɵsetClassMetadata(SocketioService, [{
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\biron\Documents\Personal\Proyectos\Jazz\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
